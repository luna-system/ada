...
impl SpriteSheet {
    ...
    pub fn load<P: AsRef<Path>>(
        ...
        eprintln!(
            "  Detected grid: {}x{} sprites, {} cols x {} rows",
        ...
        for row in 0..rows {
            for col in 0..cols {
                ...
                cr.rectangle(
                    x + 0.5,
                    y + 0.5,
                    sprite_width as f64 - 1.0,
                    sprite_height as f64 - 1.0,
                );
                let _ = cr.stroke();
            }
        }
    ...
    pub fn draw(&self, cr: &cairo::Context, col: i32, row: i32, dest_x: f64, dest_y: f64) {
        ...
        cr.set_source_surface(&self.surface, dest_x - src_x, dest_y - src_y)
            .unwrap();
