...
import { ToolTransparencyFormatter, ToolMarker } from '../formatters/ToolTransparencyFormatter';
...
describe('ToolTransparencyFormatter', () => {
    describe('extractToolMarkers', () => {
        it('should extract single tool marker', () => {
            ...
            const markers = ToolTransparencyFormatter.extractToolMarkers(content);
    ...
    describe('formatToolResults', () => {
        it('should return empty string for no markers', () => {
            const result = ToolTransparencyFormatter.formatToolResults([]);
            expect(result).toBe('');
        });
        ...
        it('should format single file badge', () => {
            ...
            const result = ToolTransparencyFormatter.formatToolResults(markers);
    ...
    describe('stripToolMarkers', () => {
        it('should remove tool markers from content', () => {
            ...
            const stripped = ToolTransparencyFormatter.stripToolMarkers(content);
