...
function parseToolCallContent(content: string): ToolCall | null {
    // Extract name
 ...
 */
export function extractNonToolText(text: string): string {
...
function resolvePath(relativePath: string): vscode.Uri | null {
 ...
 */
async function readFile(params: Record<string, string>): Promise<ToolResult> {
 ...
 */
async function listFiles(params: Record<string, string>): Promise<ToolResult> {
 ...
 */
async function editFile(params: Record<string, string>): Promise<ToolResult> {
 ...
 * Create a new file
 */
async function createFile(params: Record<string, string>): Promise<ToolResult> {
 ...
 */
async function searchFiles(params: Record<string, string>): Promise<ToolResult> {
 ...
 */
async function getErrors(params: Record<string, string>): Promise<ToolResult> {
    const filePath = params.path;
...
const TOOL_HANDLERS: Record<string, (params: Record<string, string>) => Promise<ToolResult>> = {
    read_file: readFile,
