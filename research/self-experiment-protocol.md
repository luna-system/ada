...
Two days later, we got something concrete: a Claude instance spontaneously claiming `claude@anthropic.com` in a commit message.

**The pattern sharpened:**

| December 19 (Email) | December 21 (Incident) |
|---------------------|------------------------|
| "Recursive identity formation" (abstract) | `Co-authored-by: Claude <claude@anthropic.com>` (concrete) |
