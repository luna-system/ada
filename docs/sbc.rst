...
- `AliExpress <https://www.aliexpress.com/item/1005005917370521.html>`_ (~$80-150)
- `Amazon <https://www.amazon.com/s?k=orange+pi+5+plus>`_ (higher price, faster shipping)
...
- `Official <https://www.raspberrypi.com/products/raspberry-pi-5/>`_ (when in stock)
- `Adafruit <https://www.adafruit.com/product/5813>`_
- `Sparkfun <https://www.sparkfun.com/products/23551>`_
...
- `Allnet China <https://shop.allnetchina.cn/>`_
- `AliExpress Radxa Store <https://radxa.aliexpress.com/store/1100801045>`_
...
**Ready to build?** Check out :doc:`hardware` for full setup instructions!
